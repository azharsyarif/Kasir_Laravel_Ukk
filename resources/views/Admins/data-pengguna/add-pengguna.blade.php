...
<head>
    ...
    <title>add-data-pengguna</title>
    @vite('resources/css/app.css')
</head>
<body>
@include('Components.sidebar')
<div class="p-4 sm:ml-64">
    <form class="max-w-sm mx-auto" method="POST" action="{{ route('admins.data-pengguna.create') }}">
        @csrf
        <div class="mb-5">
        ...
        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Account</button>
    </form>
</div>
</body>
</html>
